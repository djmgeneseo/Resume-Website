...
function (_Component) {
  ...
  function ScrollTrigger(props) {
    ...
    _this.onScrollThrottled = (0, _lodash.default)(_this.onScroll.bind(_assertThisInitialized(_assertThisInitialized(_this))), props.throttleScroll, {
      trailing: false
    });
    _this.onResizeThrottled = (0, _lodash.default)(_this.onResize.bind(_assertThisInitialized(_assertThisInitialized(_this))), props.throttleResize, {
      trailing: false
    });
    _this.state = {
      inViewport: false,
