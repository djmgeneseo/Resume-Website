...
import img1 from '../../../../assets/img/blogs/messapps/the-secret-behind-all-successful-apps-is-in-user-loyalty/1.jpg';
  ...
  return (
    <div>
        ...
        <Typography paragraph>
            <ExternalLink url={`http://applift.com/blog/quality-app-reviews-ratings`}>(Two-thirds of iOS apps have yet to be reviewed)</ExternalLink> Success tends to follow appreneurs who develop very niche apps: <strong>It’s wiser to earn the collective loyalty of a smaller, more identifiable audience than to invest extra resources into targeting a more diverse conglomerate.</strong>
        </Typography>
        <Typography paragraph>
