...
import img1 from '../../../../assets/img/blogs/messapps/mobile-app-beta-testing-breaking-down-the-basics/1.jpg';
...
const MobileAppBetaTestingBreakingDownTheBasics = (props) => {
  ...
  return (
    <div>
        ...
        <ol>
            <li><Typography paragraph>Post on forums and blogs whose audience might find your app appealing</Typography></li>
