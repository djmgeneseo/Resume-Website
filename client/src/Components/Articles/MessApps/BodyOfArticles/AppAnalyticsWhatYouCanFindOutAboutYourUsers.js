...
import img1 from '../../../../assets/img/articles/messapps/app-analytics-what-you-can-find-out-about-your-users/1.jpg';
import img2 from '../../../../assets/img/articles/messapps/app-analytics-what-you-can-find-out-about-your-users/2.jpg';
import img3 from '../../../../assets/img/articles/messapps/app-analytics-what-you-can-find-out-about-your-users/3.jpg';
...
const AppAnalyticsWhatYouCanFindOutAboutYourUsers = (props) => {
  ...
  return (
    <div>
        ...
        <Typography paragraph>
            Here's a list that Dave McLure - founder of startup accelerator 500 Startups - suggests in <ExternalLink url="https://500hats.typepad.com/500articles/2007/06/internet-market.html">his post about the chief metrics</ExternalLink> that startups should focus on first:
        </Typography>
