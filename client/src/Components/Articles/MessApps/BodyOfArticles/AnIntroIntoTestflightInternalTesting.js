...
import img1 from '../../../../assets/img/articles/messapps/an-intro-into-testflight-internal-testing/1.jpg';
import img2 from '../../../../assets/img/articles/messapps/an-intro-into-testflight-internal-testing/2.jpg';
import img3 from '../../../../assets/img/articles/messapps/an-intro-into-testflight-internal-testing/3.jpg';
import img4 from '../../../../assets/img/articles/messapps/an-intro-into-testflight-internal-testing/4.jpg';
import img5 from '../../../../assets/img/articles/messapps/an-intro-into-testflight-internal-testing/5.jpg';
import img6 from '../../../../assets/img/articles/messapps/an-intro-into-testflight-internal-testing/6.jpg';
import img7 from '../../../../assets/img/articles/messapps/an-intro-into-testflight-internal-testing/7.jpg';
import img8 from '../../../../assets/img/articles/messapps/an-intro-into-testflight-internal-testing/8.jpg';
import img9 from '../../../../assets/img/articles/messapps/an-intro-into-testflight-internal-testing/9.jpg';
import img10 from '../../../../assets/img/articles/messapps/an-intro-into-testflight-internal-testing/10.jpg';
import img11 from '../../../../assets/img/articles/messapps/an-intro-into-testflight-internal-testing/11.jpg';
...
const AnIntroIntoTestflightInternalTesting = (props) => {
  ...
  return (
    <div>
        ...
        All data is invaluable to your app's success; hence, aggregating information about apps pre-release has become part of the norm. Two types of beta testing exists internal (closed) and internal (open). Last time, we reviewed how to setup <Link to={"/articles/messapps/an-intro-into-testflight-external-testing"} underline="always">External Testing</Link>; now, let's focus on the <strong>Internal</strong> alternative. If you need any help deciding which method of testing to use, <Link to="/articles/messapps/mobile-app-beta-testing-breaking-down-the-basics" underline="always">click here and decide first before proceeding.</Link>
        </Typography>
