...
import img1 from '../../../../assets/img/articles/messapps/launch-day-can-be-difficult-to-prepare-for/1.jpg';
...
const LaunchDayCanBeDifficultToPrepareFor = (props) => {
  ...
  return (
    <div>
        ...
        <Typography paragraph>On your landing page, create and maintain a developer’s log. Keep your users in the loop by being transparent about your goals: write articles about what you're building, how you're building it, and about some of the problems you’ve encountered along the way. Articles are also helpful for post­release: incorporate change logs, announcements, future updates, promotional codes, etc.</Typography>
