...
import img1 from '../../../../assets/img/blogs/messapps/simple-and-effective-ways-to-gain-app-publicity/1.jpg';
...
const SimpleAndEffectiveWaysToGainAppPublicity = (props) => {
  ...
  return (
    <div>
        ...
        <Typography paragraph>
            A good first step would be to simply ask around. Use whatever connections you’ve accumulated in the app industry; you’ll be surprised to learn how many people know a journalist or a blogger who is in need of a new and exciting story. If your search comes up dry, do a little poking around on the internet:
        </Typography>
        ...
        <Typography paragraph className={classes.blockQuote}>
            “You’ll often want coverage on publications/sites that don’t review apps because their readers are predominantly your target user base. One way of getting exposure on these sites is by creating content for your site’s blog that is syndicated or linked to by your “target site”. It’s a nice fallback tactic and can enable you to create awareness of your app for people who aren’t aware that they need an app.”
        </Typography>
        <Typography paragraph>
