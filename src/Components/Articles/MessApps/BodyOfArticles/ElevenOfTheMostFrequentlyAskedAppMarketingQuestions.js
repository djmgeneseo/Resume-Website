...
const ElevenOfTheMostFrequentlyAskedAppMarketingQuestions = (props) => {
  ...
  return (
    <div>
        ...
        <Typography paragraph>
        Marketing Manager at Apptentive Alex Walz left his findings from an insightful case study of his own “to put some longstanding hypotheses through the gauntlet.” <a href="https://moz.com/article/app-store-rankings-formula-deconstructed-in-5-mad-science-experiments" rel="noopener noreferrer" target="_blank"> For more on his findings, read his article here</a>.
        </Typography>
        <Typography variant="h5">
        ...
        <ul>
            ...
            <li>
                <Typography paragraph><a href='https://www.articleger.com/about/?r=1-null_user' rel="noopener noreferrer" target="_blank">Articleger</a></Typography>   
            </li>
            <li>
