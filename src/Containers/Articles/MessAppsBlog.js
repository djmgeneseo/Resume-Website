...
import MessAppsArticle from '../../Components/Articles/MessApps/MessAppsArticle'
...
} from '../../Components/Articles/MessApps/BodyOfArticles/index';
...
const articles = [
  {
    ...
    img: require(`../../assets/img/articles/messapps/making-the-most-out-of-iOS-app-analytics/1.jpg`),
  ...
  },
  {
    ...
    img: require('../../assets/img/articles/messapps/an-intro-into-testflight-external-testing/1.jpg'),
  ...
  },
  {
    ...
    img: require('../../assets/img/articles/messapps/an-intro-into-testflight-internal-testing/1.jpg'),
    date: 'August 11th, 2016',
  ...
  },
  {
    ...
    img: require('../../assets/img/articles/messapps/ios-app-development-submitting-an-update/1.jpg'),
  ...
  },
  {
    ...
    img: require('../../assets/img/articles/messapps/finding-your-ios-devices-udid-via-itunes/1.jpg'),
  ...
  },
  {
    ...
    img: require('../../assets/img/articles/messapps/creating-your-first-ios-developer-account/1.jpg'),
  ...
  },
  {
    ...
    intro: `It's easy!`,
    img: require('../../assets/img/articles/messapps/how-to-install-xcode-and-start-your-first-project/1.jpg'),
    date: 'August 1st, 2016',
  ...
  },
  {
    ...
    img: require(`../../assets/img/articles/messapps/setting-up-your-first-project-with-android-studio/1.jpg`),
    date: `July 26th, 2016`,
  ...
  },
  {
    ...
    img: require(`../../assets/img/articles/messapps/the-secret-behind-all-successful-apps-is-in-user-loyalty/1.jpg`),
    date: `July 6th, 2016`,
  ...
  },
  {
    ...
    img: require(`../../assets/img/articles/messapps/simple-and-effective-ways-to-gain-app-publicity/1.jpg`),
    date: `July 5th, 2016`,
  ...
  },
  {
    ...
    img: require('../../assets/img/articles/messapps/boost-your-apps-growth-social-implementations/1.jpg'),
    date: 'June 25th, 2016',
  ...
  },
  {
    ...
    img: require(`../../assets/img/articles/messapps/restaurant-apps-a-closer-look-at-the-numbers/1.jpg`),
    date: `June 25th, 2016`,
  ...
  },
  {
    ...
    img: require(`../../assets/img/articles/messapps/make-any-app-successful-with-these-four-features/1.jpg`),
    date: `June 24th, 2016`,
  ...
  },
  {
    ...
    img: require(`../../assets/img/articles/messapps/the-mobile-app-business-model-made-simple/1.jpg`),
    date: `June 20th, 2016`,
  ...
  },
  {
    ...
    img: require('../../assets/img/articles/messapps/five-appreneur-books-that-guarantee-results/1.jpg'),
    date: 'June 14th, 2016',
  ...
  },
  {
    ...
    img: require('../../assets/img/articles/messapps/app-indexing-the-latest-and-greatest-in-marketing/1.jpg'),
    date: 'June 5th, 2016',
  ...
  },
  {
    ...
    img: require(`../../assets/img/articles/messapps/mobile-app-beta-testing-breaking-down-the-basics/1.jpg`),
    date: `June 5th, 2016`,
  ...
  },
  {
    ...
    img: require(`../../assets/img/articles/messapps/launch-day-can-be-difficult-to-prepare-for/1.jpg`),
    date: `June 4th, 2016`,
  ...
  },
  {
    ...
    img: require(`../../assets/img/articles/messapps/should-i-develop-my-app-alone-or-with-a-team/1.jpg`),
    date: `June 4th, 2016`,
  ...
  },
  {
    ...
    img: require(`../../assets/img/articles/messapps/speaking-code-a-review-of-the-basics/1.png`),
    date: `June 4th, 2016`,
  ...
  },
  {
    ...
    img: require(`../../assets/img/articles/messapps/the-top-five-greatest-pitfalls-in-app-marketing/1.jpg`),
    date: `June 4th, 2016`,
  ...
  },
  {
    ...
    img: require('../../assets/img/articles/messapps/app-analytics-what-you-can-find-out-about-your-users/1.jpg'),
    date: 'June 2nd, 2016',
  ...
  },
  {
    ...
    img: require('../../assets/img/articles/messapps/three-easy-ways-to-improve-your-restaurants-app/1.jpg'),
    date: 'Jan 25th, 2016',
 ...
 */
class MessAppsArticle extends Component {
  ...
  /**
   * Generates article cards for all MessApps articles
   */
  generateListOfArticles = () => {
    return articles.map((article) => {
      return (
        <ArticleCard key={article.id} theme={this.props.theme} articleLink={`messapps/${article.id}`} articleImg={article.img} articleDate={article.date} articleTitle={article.title} articleIntro={article.intro} />
      ) 
    })
  }
  ...
  /**
   * Generates <= 5 related article cards for the related article card section on each a article page 
   * @param {string} requestedArticleId - id property of the article variable
   */
  generateRelatedArticleCards = (requestedArticleId) => {
    ...
    return finalArrOfRelated.map(article => {
      return <ArticleCard sm={12} md={12} key={article.id} theme={this.props.theme} articleLink={`messapps/${article.id}`} articleImg={article.img} articleDate={article.date} articleTitle={article.title} articleIntro={article.intro} />
    })
  }
        ...
        <Grid container spacing={24}>
          ...
          <Route
              ...
              component={(reactProps) => 
                <ArticlePage arrayOfRelatedArticleCards = {this.generateRelatedArticleCards(reactProps.match.params.articleId)}>
